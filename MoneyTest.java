...
public class MoneyTest extends TestCase{
     ...
     *
     *
     * Test of add methodjunit.framework.AssertionFailedError, of class Money.
     * @throws java.lang.Exception
     */
    ...
    public void testAdd() throws Exception {
        ...
        Money expResult = new Money(323, "Euro");
        Money result = instance.add(new Money(namount, currency));
        assertFalse("There are Equals", expResult.amount()==result.amount() && expResult.currency().equals(result.currency()));
        // TODO review the generated test code and remove the default call to fail.
        //fail("The test case is a prototype.");
    }
